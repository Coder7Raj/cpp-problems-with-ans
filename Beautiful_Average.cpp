...
// avg(l,r)=1r−l+1∑i=lrai Output the maximum value of avg(l,r)//  over all choices of l,r
// .
...
// Input
// The first line contains a single integer t (1≤t≤104) — the number of test cases. The first line of each testcase contains a single integer n
//  (1≤n≤10) — the length of the array a. The second line of each testcase contains n integers a1,a2,…,an (1≤ai≤10) — the elements of the array.
